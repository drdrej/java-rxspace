	...
	static class MyObj {
		...
		public MyObj() {
			...
			binder.onChange(MyKey.KEY1, new OnChangeEntry<Integer>() {
				...
				public Integer onChange(final Enum key, final Integer newValue, final Integer olbValue) {
			...
			binder.change(MyKey.KEY1, 10); // --> key: Type in sorted Array oder
											// fast hashmap? auch hier intern
											// tx. ist nur eine einfache
											// schreibweise. wobei hier auch
											// direkt synchronized gesetzt
											// werden kann
